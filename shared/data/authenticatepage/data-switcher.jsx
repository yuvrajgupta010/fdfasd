...
import * as ErrorSwitcherData from "./error-switcher-data";
                  ...
                  <div className="swichermainleft">
                    ...
                    <div className="skin-body switch_section">
                      ...
                      <div className="switch-toggle d-flex mt-2">
                        ...
                        >
                          <img
                            src={require("../../../public/assets/images/media/bg-img1.jpg")}
                            alt="Bg-1"
                            id="bgimage1"
                          />
                        </Link>
                        ...
                        >
                          <img
                            src={require("../../../public/assets/images/media/bg-img2.jpg")}
                            alt="Bg-2"
                            id="bgimage2"
                          />
                        </Link>
                        ...
                        >
                          <img
                            src={require("../../../public/assets/images/media/bg-img3.jpg")}
                            alt="Bg-3"
                            id="bgimage3"
                          />
                        </Link>
                        ...
                        >
                          <img
                            src={require("../../../public/assets/images/media/bg-img4.jpg")}
                            alt="Bg-4"
                            id="bgimage4"
                          />
                        </Link>
